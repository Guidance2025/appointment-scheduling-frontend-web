...
// export const UPDATE_POST_URL = (id) => `${POSTS_URL}/${id}`;
// export const POST_BY_ID_URL = (id) => `${POSTS_URL}/${id}`;
...
// export const EXIT_INTERVIEW_BASE = `${API_BASE_URL}/api/exit-interview`;
// export const EXIT_INTERVIEW_QUESTIONS_URL = (staffId) =>`${EXIT_INTERVIEW_BASE}/questions/${staffId}`;
// export const EXIT_INTERVIEW_QUESTION_BY_ID_URL = (id) =>`${EXIT_INTERVIEW_BASE}/questions/${id}`;
// export const EXIT_INTERVIEW_RESPONSES_URL = `${EXIT_INTERVIEW_BASE}/responses`;
// export const EXIT_INTERVIEW_SUBMIT_RESPONSE_URL = (studentId) =>`${EXIT_INTERVIEW_BASE}/responses/${studentId}`;